...
| Task | 任务中心 v0.2 | 四类 profile_version、task_plan/version、task_run、task_run_manifest、execution_unit、unit_attempt、task_run_event、workflow identity registry / start intent；schedule 待后续 | P5-00B1 Application / Repository 契约；task-plans、task-runs、commands、events 公共 API 待后续 | Launch、Task Control | 基础中：P5-00A / P5-00B1 已验收，正式 Profile、stable request digest、deterministic Workflow identity、materialization seal、Revision CAS 与 Pending Start Intent 已落地；Intent Consumer、Temporal 编排、大批次分区物化和公共控制面未开始 |
