...
- P9 将继续验证故障注入、容量、隔离、黄金链与 SLO；生产部署仍需真实 Receiver Endpoint / Key、Network Policy、Secret Manager 与运行告警。
