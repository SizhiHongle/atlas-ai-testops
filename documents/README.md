...
- TaskPlan、TaskPlanVersion、Manual Launch、Task 执行对象、四类 Profile 与 Task Unit Execution Ticket 机器 Schema 已导出；AttemptSeal、Result Snapshot 和 Insight Schema 会在对应领域代码落地时增加，不提前创建空契约。
