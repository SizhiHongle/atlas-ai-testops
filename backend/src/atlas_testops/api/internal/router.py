...
from atlas_testops.api.internal.live_control import router as live_control_router
...
internal_api_router.include_router(live_control_router, tags=["browser-live-control"])
